...
def parse_main_args():
	...
	parser.add_argument("--stats", "-s", required=True, type=str2bool, nargs='?', default=True, help="Show jobs stats.")
	parser.add_argument("--plot", "-pl", required=True, type=str2bool, nargs='?', default=True, help="Plot jobs stats.")
